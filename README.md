# SeedPEA Community Branch Draft v0.10
...
- seed useful beginnings;
- keep ethical boundaries active;
- preserve only what can responsibly carry forward;
- use REWASH before distorted material persists;
- avoid authority inflation;
- protect privacy without shielding harm;
- keep human action in the choosing layer;
- make adaptation allowed and inversion visible.
...
Start with the main document. Use the extension when you need more detail on licensing, responsibility, surveillance limits, governance claims, branch labels, or trace burden.
...
Leave quiet.
Leave room.
Do not consume all the empty space.
